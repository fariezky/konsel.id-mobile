...
class Berhasil_Reset_Screen extends StatelessWidget {
  Berhasil_Reset_Screen({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "Selamat Anda baru saja melakukan riset Password.",
                              style: TextStyle(
                                color: tBlack,
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "Sekarang Anda sudah bisa Login kembali.",
                              style: TextStyle(
                                color: tBlack,
                                fontSize: isTab(context) ? 6.sp : 9.sp,
                              ),
